...
When you run WinGames from within [An Internal Link](/guides/content/editing-an-existing-page) (cartridge-version) and choose "Shutdown" in the WinGames start menu, you get right back to the GUI64 desktop.
